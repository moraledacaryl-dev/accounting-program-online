...
export default function PayablesPage() {
  ...
  async function reversePayment(transactionIdRaw) {
    ...
    setNotice('');
    try {
      await reversePayablePayment(reverseTarget.id, transactionId, { reason: 'Reversed from payables page' });
  ...
  return (
    <div className="stack">
      ...
      <InputActionModal
        open={!!reverseTarget}
        title={`Reverse payment for bill #${reverseTarget?.id}?`}
        description="Enter the payment transaction ID. This reverses that payment and recalculates the bill balance."
