...
const titles = {
  ...
  '/bookings/calendar': ['Calendar', 'Booking availability and dates'],
  ...
  '/room-folios': ['Guest Folios', 'Charges, deposits, payments, refunds, and balances'],
  ...
  '/restaurant-ops': ['Restaurant / POS', 'Sales, SKU flow, and stock deduction'],
  ...
  '/journals': ['Journal Entries', 'Journal entries and trial balance'],
  '/reports': ['Reports', 'Management and accounting reports'],
  '/assets': ['Fixed Assets', 'Capitalization, depreciation, impairment, and disposal'],
  '/bir': ['Tax & Period Close', 'Books, tax controls, and locked periods'],
  '/attachments': ['Files & Evidence', 'Operational and accounting support files'],
  ...
  '/account-mapping': ['Posting Rules', 'Posting rules by module and category'],
